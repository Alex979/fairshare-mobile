...
export default function InputScreen() {
  ...
  const pickFromGallery = async () => {
    ...
    if (!permissionResult.granted) {
      Alert.alert("Permission needed", "Please allow access to your photos to upload a receipt.");
      return;
    }
      ...
      >
        ...
        <View style={styles.header}>
          <View style={styles.logoContainer}>
            <Ionicons name="pie-chart" size={isVerySmall ? 18 : 22} color="#fff" />
          </View>
        ...
        >
          ...
          <TouchableOpacity
            style={[
              styles.imageSection,
              isVerySmall ? { height: 140 } : isSmall ? { height: 180 } : { flex: 1, minHeight: 200 }
            ]}
          ...
          <View style={styles.inputSection}>
            ...
            <TextInput
              ...
              placeholder={isVerySmall ? "How to split the bill..." : "Describe how to split the bill..."}
...
const createStyles = (isDark: boolean, isVerySmall: boolean, isSmall: boolean) =>
  StyleSheet.create({
    container: {
      flex: 1,
